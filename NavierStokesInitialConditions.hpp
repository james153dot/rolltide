...
#include "flow/flow_models/FlowModels.hpp" // where???????
...
class NavierStokesInitialConditions
{
    public:
        NavierStokesInitialConditions(
...
#endif /* NAVIER_STOKES_INITIAL_CONDITIONS_HPP */
